    ...
    <div className="min-h-screen bg-paper-50">
      <div className="mx-auto max-w-5xl px-6 py-8">
        <div>
          ...
          {wallet ? (
            <div className="mt-3 text-xs text-paper-800/75">
              Cüzdan:{" "}
        ...
        <section className="mt-8 rounded-xl border border-paper-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            <label className="block">
              <div className="mb-1 text-sm font-medium text-paper-800">Planlanan tarih/saat</div>
              <input
                type="datetime-local"
                value={whenLocal}
            ...
            <label className="block sm:col-span-2">
              <div className="mb-1 text-sm font-medium text-paper-800">Konu</div>
              <input
                value={topic}
          ...
          <div className="mt-4 flex items-center justify-between gap-3">
            <div className="text-xs text-paper-800/55">
              Toplam: <span className="font-mono font-medium text-paper-900">1000,00 TL</span>
            </div>
            <button
              type="button"
        ...
        <section className="mt-10">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-semibold text-paper-900">Açık ilanlar</h2>
            <button
              type="button"
              onClick={() => token && void load(token)}
              className="rounded-xl border border-paper-200 bg-white px-3 py-2 text-sm font-medium text-paper-900 shadow-sm"
            >
              Yenile
            </button>
          </div>
          {loading ? (
            <div className="mt-4 text-sm text-paper-800/75">Yükleniyor…</div>
          ) : (
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                          ...
                          <div className="mt-2 text-xs text-paper-800/75">
                            ...
                            <span className="font-mono font-medium text-paper-900"> {tl(share)} TL</span>
                          </div>
                          {available != null && (
