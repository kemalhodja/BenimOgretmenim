...
import { ItirazIntro } from "./ItirazIntro";
...
export default function ItirazPage() {
  const pathname = usePathname() ?? "/itiraz";
    ...
    <div className="min-h-screen bg-paper-50">
      <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        ...
        {!authChecked ? null : !token ? (
          <div
            className="mt-8 rounded-2xl border border-brand-200 bg-brand-50 p-5 shadow-sm"
            data-testid="itiraz-login-cta"
          >
            <h2 className="text-sm font-semibold text-paper-900">İtiraz açmak için giriş yapın</h2>
            <p className="mt-2 text-sm leading-relaxed text-paper-800/75">
              Mevcut itirazlarınızı görmek ve yeni kayıt oluşturmak için hesabınızla giriş yapmanız gerekir.
            </p>
          ...
          <>
            ...
            <form
              ...
              className="mt-8 space-y-4 rounded-2xl border border-paper-200 bg-white p-5 shadow-sm"
            >
            ...
            <ul className="mt-3 space-y-3">
              {disputes.length === 0 ? (
                <li className="rounded-xl border border-paper-200 bg-white p-4 text-sm text-paper-800/55">
                  Henüz itiraz yok.
                </li>
              ) : (
                disputes.map((d) => (
